    ...
    <DashboardLayout>
      ...
      <Card className="dashboard-card mb-8 bg-primary/5 border-primary/20">
        <CardHeader>
          ...
          <CardDescription>شارك الرابط أو الكود مع عملائك لتحصل على العمولة تلقائياً (20% من قيمة الاشتراك وأول عملية بيع)</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-2">
              <label className="text-sm font-medium text-muted-foreground">رابط الإحالة المباشر (Deep Link)</label>
              <div className="flex gap-2">
                ...
                <Button variant="secondary" size="icon" onClick={() => {
                  if (navigator.share) {
                    navigator.share({ url: referralLink, title: "انضم إلى DASMe واحصل على خصم!" });
                  } else {
                    copyToClipboard(referralLink, "تم نسخ الرابط بنجاح");
                  }
                }}>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                كل مستخدم يسجل عبر هذا الرابط سيُربط بك تلقائياً للأبد
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                يمكن للعملاء استخدام هذا الكود عند التسجيل أو الشراء
              </p>
            </div>
          </div>
          <div className="mt-4 p-4 bg-background rounded-lg border border-border">
            <h4 className="font-medium text-sm mb-2">معلومات العمولة:</h4>
            <ul className="text-xs text-muted-foreground space-y-1 list-disc list-inside">
              <li>20% من قيمة اشتراك العميل الجديد</li>
              <li>20% من قيمة أول عملية بيع للعميل داخل المنصة</li>
              <li>عمولة مستمرة على كل عملية بيع لاحقة (حسب الرتبة)</li>
            </ul>
          </div>
        </CardContent>
      </Card>
